import '../select_payments_two_screen/widgets/paytmcomponent_item_widget.dart';import 'package:flutter/material.dart';import 'package:home_services/core/app_export.dart';import 'package:home_services/widgets/app_bar/appbar_leading_iconbutton.dart';import 'package:home_services/widgets/app_bar/appbar_title.dart';import 'package:home_services/widgets/app_bar/custom_app_bar.dart';import 'package:home_services/widgets/custom_elevated_button.dart';import 'package:home_services/widgets/custom_radio_button.dart';
// ignore_for_file: must_be_immutable
class SelectPaymentsTwoScreen extends StatelessWidget {SelectPaymentsTwoScreen({Key? key}) : super(key: key);
...
/// Section Widget
Widget _buildProceed(BuildContext context) { return CustomElevatedButton(text: "Proceed", margin: EdgeInsets.only(left: 16.h, right: 16.h, bottom: 36.v), onPressed: () {onTapProceed(context);}); } 

/// Navigates back to the previous screen.
onTapArrowLeft(BuildContext context) { Navigator.pop(context); } 
/// Navigates to the paymentSuccessThreeScreen when the action is triggered.
onTapProceed(BuildContext context) { Navigator.pushNamed(context, AppRoutes.paymentSuccessThreeScreen); } 
 }
