...
class OnboardingScreen2RealImagesScreen
    extends GetWidget<OnboardingScreen2RealImagesController> {
  const OnboardingScreen2RealImagesScreen({Key? key}) : super(key: key);
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Container(
                ...
                padding: EdgeInsets.symmetric(horizontal: 23.h, vertical: 3.v),
                child: Column(children: [
                  Padding(
                      ...
                      child: Column(children: [
                        ...
                        Container(
                            width: 298.h,
                            margin: EdgeInsets.only(left: 16.h, right: 13.h),
                            child: Text("msg_easy_service_booking".tr,
                                maxLines: 2,
  ...
  Widget _buildWidget() {
    return Container(
        ...
        decoration: AppDecoration.fillGray10001
            .copyWith(borderRadius: BorderRadiusStyle.circleBorder164),
        child: CustomImageView(
            imagePath: ImageConstant.imgImage2357,
            height: 286.adaptSize,
            width: 286.adaptSize,
            radius: BorderRadius.circular(143.h)));
  }

  /// Navigates to the onboardingScreen3RealImagesScreen when the action is triggered.
  onTapBtnIconButton() {
    Get.toNamed(
