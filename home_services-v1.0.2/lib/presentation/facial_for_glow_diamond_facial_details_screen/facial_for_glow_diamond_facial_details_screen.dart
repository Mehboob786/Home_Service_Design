...
class FacialForGlowDiamondFacialDetailsScreen
    extends GetWidget<FacialForGlowDiamondFacialDetailsController> {
  const FacialForGlowDiamondFacialDetailsScreen({Key? key}) : super(key: key);
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                        padding: EdgeInsets.only(left: 8.h),
                        child: _buildPrice(
                            price: "lbl_799".tr, oldPrice: "lbl_1299".tr)),
                    SizedBox(height: 15.v),
                    CustomImageView(
          ...
          Row(
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(height: 7.v),
                  _buildPrice(price: "lbl_799".tr, oldPrice: "lbl_1299".tr),
                  SizedBox(height: 15.v),
