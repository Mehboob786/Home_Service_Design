...
import 'package:home_services/presentation/cancel_anyway_bottomsheet/cancel_anyway_bottomsheet.dart';
import 'package:home_services/presentation/cancel_anyway_bottomsheet/controller/cancel_anyway_controller.dart';

class CancelBookingSelectedAPointScreen
    extends GetWidget<CancelBookingSelectedAPointController> {
  const CancelBookingSelectedAPointScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildGroup232RadioGroup() {
    return Align(
            ...
            child: Obx(() => Column(children: [
                  Padding(
                      ...
                      child: CustomRadioButton(
                          ...
                          value: controller.cancelBookingSelectedAPointModelObj
  ...
  Widget _buildCancelNowButton() {
    return CustomElevatedButton(
        ...
        onPressed: () {
          onTapCancelNowButton();
        });
  }

  /// Displays a scrollable bottom sheet widget using the [Get] package
  /// and the [CancelAnywayBottomsheet] widget.
  ///
  /// The bottom sheet is controlled by the [CancelAnywayController]
  /// and is displayed using the [Get.bottomSheet] method with
  /// [isScrollControlled] set to true.

  onTapCancelNowButton() {
    Get.bottomSheet(
      CancelAnywayBottomsheet(
        Get.put(
          CancelAnywayController(),
        ),
      ),
