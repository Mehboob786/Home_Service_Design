import 'controller/add_address_final_one_controller.dart';
...
class AddAddressFinalOneBottomsheet extends StatelessWidget {
  AddAddressFinalOneBottomsheet(this.controller, {Key? key}) : super(key: key);

  AddAddressFinalOneController controller;
