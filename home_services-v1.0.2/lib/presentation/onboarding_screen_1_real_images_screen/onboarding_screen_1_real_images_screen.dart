...
class OnboardingScreen1RealImagesScreen
    extends GetWidget<OnboardingScreen1RealImagesController> {
  const OnboardingScreen1RealImagesScreen({Key? key})
      : super(
          key: key,
        );
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        "msg_we_provide_professional".tr,
                        maxLines: 3,
